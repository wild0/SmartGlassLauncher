...
import com.orangicetech.smartglasslauncher.launcher.SGLauncherSetting.Favorites;

/**
 * Created by roy on 2015/1/20.
 */
public class SGLauncherProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private int copyFromCursor(SQLiteDatabase db, Cursor c) {
            ...
            final int iconTypeIndex = c.getColumnIndexOrThrow(SGLauncherSetting.Favorites.ICON_TYPE);
            final int iconIndex = c.getColumnIndexOrThrow(SGLauncherSetting.Favorites.ICON);
            final int iconPackageIndex = c.getColumnIndexOrThrow(SGLauncherSetting.Favorites.ICON_PACKAGE);
            final int iconResourceIndex = c.getColumnIndexOrThrow(SGLauncherSetting.Favorites.ICON_RESOURCE);
            ...
            final int displayModeIndex = c.getColumnIndexOrThrow(SGLauncherSetting.Favorites.DISPLAY_MODE);

            ContentValues[] rows = new ContentValues[c.getCount()];
            int i = 0;
            while (c.moveToNext()) {
                ContentValues values = new ContentValues(c.getColumnCount());
                values.put(SGLauncherSetting.Favorites._ID, c.getLong(idIndex));
                values.put(SGLauncherSetting.Favorites.INTENT, c.getString(intentIndex));
                values.put(SGLauncherSetting.Favorites.TITLE, c.getString(titleIndex));
                values.put(SGLauncherSetting.Favorites.ICON_TYPE, c.getInt(iconTypeIndex));
                values.put(SGLauncherSetting.Favorites.ICON, c.getBlob(iconIndex));
                values.put(SGLauncherSetting.Favorites.ICON_PACKAGE, c.getString(iconPackageIndex));
                values.put(SGLauncherSetting.Favorites.ICON_RESOURCE, c.getString(iconResourceIndex));
                values.put(SGLauncherSetting.Favorites.CONTAINER, c.getInt(containerIndex));
                values.put(SGLauncherSetting.Favorites.ITEM_TYPE, c.getInt(itemTypeIndex));
                values.put(SGLauncherSetting.Favorites.APPWIDGET_ID, -1);
                values.put(SGLauncherSetting.Favorites.SCREEN, c.getInt(screenIndex));
                values.put(SGLauncherSetting.Favorites.CELLX, c.getInt(cellXIndex));
                values.put(SGLauncherSetting.Favorites.CELLY, c.getInt(cellYIndex));
                values.put(SGLauncherSetting.Favorites.URI, c.getString(uriIndex));
                values.put(SGLauncherSetting.Favorites.DISPLAY_MODE, c.getInt(displayModeIndex));
                rows[i++] = values;
            }
                    ...
                    if (intentUri != null) {
                        try {
                            ...
                            if (Intent.ACTION_VIEW.equals(intent.getAction()) &&
                                ...
                                values.clear();
                                values.put(SGLauncherSetting.Favorites.INTENT, intent.toUri(0));
            ...
            try {
                ...
                while (c != null && c.moveToNext()) {
                    ...
                    try {
                        ...
                        values.put(SGLauncherSetting.Favorites.SPANX, 2);
                        values.put(SGLauncherSetting.Favorites.SPANY, 2);
        ...
        private int loadFavorites(SQLiteDatabase db) {
            ...
            try {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    values.clear();
                    values.put(SGLauncherSetting.Favorites.CONTAINER,
                            SGLauncherSetting.Favorites.CONTAINER_DESKTOP);
                    values.put(SGLauncherSetting.Favorites.SCREEN,
                            a.getString(R.styleable.Favorite_screen));
                    values.put(SGLauncherSetting.Favorites.CELLX,
                            a.getString(R.styleable.Favorite_x));
                    values.put(SGLauncherSetting.Favorites.CELLY,
