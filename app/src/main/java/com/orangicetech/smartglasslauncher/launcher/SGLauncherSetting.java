...
class SGLauncherSetting {
    ...
    static final class Favorites implements BaseLauncherColumns {
        ...
        static final Uri CONTENT_URI = Uri.parse("content://" +
                SGLauncherProvider.AUTHORITY + "/" + SGLauncherProvider.TABLE_FAVORITES +
                "?" + SGLauncherProvider.PARAMETER_NOTIFY + "=true");
        ...
        static final Uri CONTENT_URI_NO_NOTIFICATION = Uri.parse("content://" +
                SGLauncherProvider.AUTHORITY + "/" + SGLauncherProvider.TABLE_FAVORITES +
                "?" + SGLauncherProvider.PARAMETER_NOTIFY + "=false");
        ...
        static Uri getContentUri(long id, boolean notify) {
            return Uri.parse("content://" + SGLauncherProvider.AUTHORITY +
                    "/" + SGLauncherProvider.TABLE_FAVORITES + "/" + id + "?" +
                    SGLauncherProvider.PARAMETER_NOTIFY + "=" + notify);
        }
